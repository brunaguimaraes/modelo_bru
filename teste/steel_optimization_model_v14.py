...
# base_production = steel_total_target.loc[2023, 'Total']   aqui antes eu pegava a produção histórica divulgada pelo setr siderúrgico, mas na realidade quero usar a produção dada pela minha base de dados endógena do modelo (com as plantas idividualizadas).
